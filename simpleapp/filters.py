...
class PostFilter(django_filters.FilterSet):
    ...
    title = django_filters.CharFilter(
        field_name='title', label='Название:', lookup_expr='icontains',
    ...
    date_time__gt = django_filters.DateFilter(
        field_name="dateCreation", label="От даты", lookup_expr='gt',
        widget=django.forms.DateInput(
            attrs={'type': 'date', 'class': "form-control"}))

    date_time__lt = django_filters.DateFilter(
        field_name="dateCreation", label="До даты", lookup_expr='lt',
        widget=django.forms.DateInput(
            attrs={'type': 'date', 'class': "form-control"}))
    ...
    class Meta:
        ...
        fields = ['title', 'type', 'date_time__gt', 'date_time__lt']
